...
create_clock -name wbs_clk_i -period 10.0000 
create_clock -name sdram_clk -period 20.0000 
create_clock -name sdram_pad_clk -period 20.0000 
create_clock -name cpu_clk -period 20.0000 
create_clock -name rtc_clk -period 50.0000 
create_clock -name line_clk -period 100.0000 
set_clock_uncertainty -rise_from [get_clocks {wbm_clk_i}] -rise_to [get_clocks {wbm_clk_i}]  -hold 0.0500
set_clock_uncertainty -rise_from [get_clocks {wbm_clk_i}] -rise_to [get_clocks {wbm_clk_i}]  -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {wbm_clk_i}] -fall_to [get_clocks {wbm_clk_i}]  -hold 0.0500
set_clock_uncertainty -rise_from [get_clocks {wbm_clk_i}] -fall_to [get_clocks {wbm_clk_i}]  -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {wbm_clk_i}] -rise_to [get_clocks {wbm_clk_i}]  -hold 0.0500
set_clock_uncertainty -fall_from [get_clocks {wbm_clk_i}] -rise_to [get_clocks {wbm_clk_i}]  -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {wbm_clk_i}] -fall_to [get_clocks {wbm_clk_i}]  -hold 0.0500
set_clock_uncertainty -fall_from [get_clocks {wbm_clk_i}] -fall_to [get_clocks {wbm_clk_i}]  -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {wbs_clk_i}] -rise_to [get_clocks {wbs_clk_i}]  -hold 0.0500
set_clock_uncertainty -rise_from [get_clocks {wbs_clk_i}] -rise_to [get_clocks {wbs_clk_i}]  -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {wbs_clk_i}] -fall_to [get_clocks {wbs_clk_i}]  -hold 0.0500
set_clock_uncertainty -rise_from [get_clocks {wbs_clk_i}] -fall_to [get_clocks {wbs_clk_i}]  -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {wbs_clk_i}] -rise_to [get_clocks {wbs_clk_i}]  -hold 0.0500
set_clock_uncertainty -fall_from [get_clocks {wbs_clk_i}] -rise_to [get_clocks {wbs_clk_i}]  -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {wbs_clk_i}] -fall_to [get_clocks {wbs_clk_i}]  -hold 0.0500
set_clock_uncertainty -fall_from [get_clocks {wbs_clk_i}] -fall_to [get_clocks {wbs_clk_i}]  -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {sdram_clk}] -rise_to [get_clocks {sdram_clk}]  -hold 0.0500
set_clock_uncertainty -rise_from [get_clocks {sdram_clk}] -rise_to [get_clocks {sdram_clk}]  -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {sdram_clk}] -fall_to [get_clocks {sdram_clk}]  -hold 0.0500
set_clock_uncertainty -rise_from [get_clocks {sdram_clk}] -fall_to [get_clocks {sdram_clk}]  -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {sdram_clk}] -rise_to [get_clocks {sdram_clk}]  -hold 0.0500
set_clock_uncertainty -fall_from [get_clocks {sdram_clk}] -rise_to [get_clocks {sdram_clk}]  -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {sdram_clk}] -fall_to [get_clocks {sdram_clk}]  -hold 0.0500
set_clock_uncertainty -fall_from [get_clocks {sdram_clk}] -fall_to [get_clocks {sdram_clk}]  -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {sdram_pad_clk}] -rise_to [get_clocks {sdram_clk}]  -hold 0.0500
set_clock_uncertainty -rise_from [get_clocks {sdram_pad_clk}] -rise_to [get_clocks {sdram_clk}]  -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {sdram_pad_clk}] -fall_to [get_clocks {sdram_clk}]  -hold 0.0500
set_clock_uncertainty -rise_from [get_clocks {sdram_pad_clk}] -fall_to [get_clocks {sdram_clk}]  -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {sdram_pad_clk}] -rise_to [get_clocks {sdram_clk}]  -hold 0.0500
set_clock_uncertainty -fall_from [get_clocks {sdram_pad_clk}] -rise_to [get_clocks {sdram_clk}]  -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {sdram_pad_clk}] -fall_to [get_clocks {sdram_clk}]  -hold 0.0500
set_clock_uncertainty -fall_from [get_clocks {sdram_pad_clk}] -fall_to [get_clocks {sdram_clk}]  -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {cpu_clk}] -rise_to [get_clocks {cpu_clk}]  -hold 0.0500
set_clock_uncertainty -rise_from [get_clocks {cpu_clk}] -rise_to [get_clocks {cpu_clk}]  -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {cpu_clk}] -fall_to [get_clocks {cpu_clk}]  -hold 0.0500
set_clock_uncertainty -rise_from [get_clocks {cpu_clk}] -fall_to [get_clocks {cpu_clk}]  -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {cpu_clk}] -rise_to [get_clocks {cpu_clk}]  -hold 0.0500
set_clock_uncertainty -fall_from [get_clocks {cpu_clk}] -rise_to [get_clocks {cpu_clk}]  -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {cpu_clk}] -fall_to [get_clocks {cpu_clk}]  -hold 0.0500
set_clock_uncertainty -fall_from [get_clocks {cpu_clk}] -fall_to [get_clocks {cpu_clk}]  -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {rtc_clk}] -rise_to [get_clocks {rtc_clk}]  -hold 0.0500
set_clock_uncertainty -rise_from [get_clocks {rtc_clk}] -rise_to [get_clocks {rtc_clk}]  -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {rtc_clk}] -fall_to [get_clocks {rtc_clk}]  -hold 0.0500
set_clock_uncertainty -rise_from [get_clocks {rtc_clk}] -fall_to [get_clocks {rtc_clk}]  -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {rtc_clk}] -rise_to [get_clocks {rtc_clk}]  -hold 0.0500
set_clock_uncertainty -fall_from [get_clocks {rtc_clk}] -rise_to [get_clocks {rtc_clk}]  -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {rtc_clk}] -fall_to [get_clocks {rtc_clk}]  -hold 0.0500
set_clock_uncertainty -fall_from [get_clocks {rtc_clk}] -fall_to [get_clocks {rtc_clk}]  -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {line_clk}] -rise_to [get_clocks {line_clk}]  -hold 0.0500
set_clock_uncertainty -rise_from [get_clocks {line_clk}] -rise_to [get_clocks {line_clk}]  -setup 0.2000
set_clock_uncertainty -rise_from [get_clocks {line_clk}] -fall_to [get_clocks {line_clk}]  -hold 0.0500
set_clock_uncertainty -rise_from [get_clocks {line_clk}] -fall_to [get_clocks {line_clk}]  -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {line_clk}] -rise_to [get_clocks {line_clk}]  -hold 0.0500
set_clock_uncertainty -fall_from [get_clocks {line_clk}] -rise_to [get_clocks {line_clk}]  -setup 0.2000
set_clock_uncertainty -fall_from [get_clocks {line_clk}] -fall_to [get_clocks {line_clk}]  -hold 0.0500
